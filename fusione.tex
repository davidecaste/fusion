...
variants~\cite{ack2005adhesive,ehrig2006weak}.  This has been largely
...
\begin{example}\todo{identit� consistente non implica astrazione}Notice that the \Cref{ex:empty} cannot, in general, be generalized to non-empty derivations. A counterexample si the following one.
\end{example}
