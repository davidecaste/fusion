...
Another categorical construction which preserves adhesivity property is the formation of the category of functors.
...
\begin{enumerate}
	...
	The bottom face is a Van Kampen square and so its top one is a pushout. The thesis now follows from \Cref{lem:po1}. This follows at once from \Cref{prop:stab}.
...
\end{lemma}
\begin{proof} Consider two permutations $\sigma$ and $\sigma': n+1 \rightrightarrows n+1$
\end{proof}
