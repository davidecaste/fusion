...
\[\xymatrix@R=15pt@C=15pt{&&R_1 \ar[dl]_{j_0}\ar[dd]^{c'_0} \ar@{.>}[dr]^{c_0}\\&D_2 \ar[dl]_{f_2}&&\hat{D}_1 \ar[dr]^{\hat{g}_1}\\G_2 && P\ar[dr]_{q_2} \ar[ur]_{q_1}\ar[dl]^{p_1} \ar[ul]_{p_2}&&G'_2\\& D'_1 \ar[ul]^{g'_1}&&D'_2 \ar[ur]_{f'_2}}\]
