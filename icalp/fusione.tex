...
%  potentially in parallel.
  ...
  very general instance of the DPO approach to rewriting.\todo{[A] direi: ``...
    in the context of the Double Pushout (DPO) Approach to rewriting in adhesive categories.''}
    More
...
consistent permutations~\cite{Handbook, BaldanCHKS06, tobias}.\todo{Handbook, graph processes, tobias}
...
\begin{example}
  ...
  strong enforcing, by the results of Appendix~\ref{app:fill}, summarized in~\Cref{ex:graph-type-bb} and~\Cref{cor:llr-is-strEnf}.
\end{example}
...
\begin{restatable}[Globality of independence]{lemma}{lemIndepGlobalLeft}
	...
	Let $\X$ be an $\mathcal{M}$-adhesive category and
	$(\X,\R)$ a well switching DPO rewriting system.
For every  derivation
	...
	\begin{enumerate}
		...
		suppose that $\dder{D}_1 \seqind\dder{D}_2$ with independence pair $(\alpha_0, \alpha_1)$ and that, moreover,  $\dder{D}_0\seqind S_{\alpha_0, \alpha_1}(\dder{D}_2)\seqind $, if there is a switching sequence
...
\begin{restatable}[Confluence of switchings]{lemma}{lemSwitchConfluence}
	...
	well-switching DPO rewriting system.
	% 
