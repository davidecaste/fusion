...
%\end{theorem}
$\mathcal{M}$-adhesivity is well-behaved with respect to  the construction of slice caregories, \cite{mac2013categories}, as shown by the following theorem.
...
holds for linear rules (see \Cref{prop:equi}). The result is so fundamental that it is
...
\begin{definition}[Good independence pair]
  ...
  \[
    \xymatrix@C=15pt{L_0 \ar[d]_{m_0}&& K_0
      \ar[d]_{k_0}\ar@{>->}[ll]_{l_0} \ar[r]^{r_0} \ar@/^.20cm/[ddrr]|(.3)\hole|(.55)\hole^(.7){u_0} & R_0
      \ar@/^.35cm/[drrr]|(.3)\hole_(.4){i_0} \ar[dr]|(.3)\hole_{h_0}
      && L_1 \ar@/_.35cm/[dlll]^(.4){i_1} \ar[dl]|(.3)\hole^{m_1}& K_1
      \ar[d]^{k_1}\ar@{>->}[l]_{l_1} \ar[rr]^{r_1} \ar@/_.20cm/[ddll]|(.3)\hole|(.55)\hole_(.7){u_1} && R_1 \ar[d]^{h_1} \\
      %
      G_0 &&
  ...
  ($i \in \{0,1\}$) and the arrows $u_0\colon K_0\to P$ and
  $u_1\colon K_1\to P$ given by \Cref{prop:tec} .
  %
...
We can now prove the Local Church-Rosser Theorem for good independence pairs.
...
We need a last technical result before proving that  an $\mathcal{M}$-adhesive category of type $\mathbb{B}$ satisfy the $\mathcal{M}$-mixed and $\mathcal{M}$-pushout decomposition properties.

\noindent
\parbox{11cm}{\begin{proposition}\label{prop:po2}
Let $\X$ be an $\mathcal{M}$-adhesive category of type $\mathbb{B}$, and suppose that the square on the right is an $\mathcal{M}$ pullback. Then there exists $E\in \X$, $e\mto E\to C$ in $\mathcal{M}$ such that $(C, \{n, e\})$
\end{proposition}} \parbox{3cm}{$\xymatrix{A  \ar[r]^{f} \ar@{>->}[d]_{n}& B \ar@{>->}[d]^{m}\\ C\ar[r]_{g} & D}$}
\begin{proof}
	contenuto...
\end{proof}
