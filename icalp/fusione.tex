...
% direct shift
\newcommand{\shift}[1][]{\ensuremath{\mathrel{{\leftrightsquigarrow}^{\mathit{sh}}_{#1}}}}
...
\begin{definition}[Switch equivalence]
  ...
  $\der{D} \shift_{(i,i+1)} \der{E}$. Then \emph{switch
...
In the case of linear rewriting systems, the characterisation of switch equivalence based on consistent
permutation allows to derive some simple but
...
\begin{restatable}[Second 3-steps Lemma]{lemma}{lemIndepGlobalLeft}
