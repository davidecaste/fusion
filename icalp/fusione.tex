...
\subsection{Well-switchable rewriting systems}
...
(e.g., in the encoding of process calculi ..., ...) are \todo{INSERIRE
  ESEMPI QUI} actually well switching.
%
...
The class of well-switchable adhesive rewriting systems is large. Generalising a result in~\cite{baldan2011adhesivity},
we can show that one of its defining properties (the fact that sequential independence implies switchability) holds 
for a class of adhesive categories which include all presheaves over \cat{Set}. Moreover, the second property, uniqueness 
...
research. \todo{P: cite} We plan to make the correspondence precise
