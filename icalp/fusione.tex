...
\begin{abstract}
  ...
  restriction to well-behaved classes of left-linear
...
\begin{restatable}[Globality of indepedence]{lemma}{lemIndepGlobalLeft}
...
rewriting systems.\todo{P: copunter example} Still, we can identify a
