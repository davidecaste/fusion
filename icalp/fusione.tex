...
like, e.g., SqPO~\cite{CorradiniHHK06}
...
We performed an in-depth investigation of notion of independence between
rewriting steps in the setting of left-linear rewriting systems
over adhesive categories, which encompasses most of the
structures commonly used in analysis and modelling applications.
