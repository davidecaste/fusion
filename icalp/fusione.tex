...
\begin{abstract}
  When can two sequences of steps executed by a computational device
  ...
  preserve and generate entities, as linear rules do, but also have
  the capability of ``merging'' parts of the state.
  % 
  ...
  systems does not work out of the box.
  %
  ...
  holds, and this requires a substantial revision of the
  theory.
  %
  The paper performs an in-depth study of the notion of independence,
  for left-linear rules, introduces a novel characterisation of
