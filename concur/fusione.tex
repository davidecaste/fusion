...
merged while edges cannot). The idea here is to consider as graphs presheaves on categories in which there are object which plays the roles of \emph{roots}, i.e.~objects which are not codomains of any arrows beside the identity. \todo{D: quest'ultima frase ha senso?}%We first introduce signatures that are
