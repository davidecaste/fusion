...
Left-linear rewriting systems on $\cat{EGraphs}$, %\todo{A: sostituirei ``, i.e. in which'' con ``where''. Giusto?} 
i.e.~where the right half of a rule is mono but not regular in general, 
