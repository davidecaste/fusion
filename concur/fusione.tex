...
It is worth noting that our framework still allows for the parallel application of sequentially independent rules \cite{ehrig2014adhesive}. To ensure this, however, one must require that the underlying category $\X$ has binary coproducts and that the class $\mathcal{M}$ is closed under them.
