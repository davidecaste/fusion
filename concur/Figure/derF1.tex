...
%      \node [above=of K1] {$\rho_2$};
      \node [above] at (K1.north) {$\lambda_1$};
      \node [right=of K1](R1) {
        \begin{tikzpicture}
          \node at (0,0.53) {}; 
...
%      \node [above=of K2] {$\rho_2$};
      \node [above] at (K2.north) {$\lambda_2$};
      \node [right=of K2] (R2) {
        \begin{tikzpicture}
          \node at (0,0.53) {}; 
          \node at (0,0) [node, label=below:$12$] (12) {};
...
%      \node [above=of K0] {$\rho_0$};
      \node [above] at (K0.north) {$\lambda_0$};
      \node [right=of K0] (R0) {
        \begin{tikzpicture}
          %
          \node at (0,0.53) {}; 
      ...
      \path (L1) edge[->] node[trans, above] {} (G0);
      \path (K1) edge[->] node[trans, above] {} (D0);
      \path (R1) edge[->] node[trans, above] {} (G1);
      ...
      \path (L2) edge[->] node[trans, above] {} (G1);
      \path (K2) edge[->] node[trans, above] {} (D1);
      \path (R2) edge[->] node[trans, above] {} (G2);
      ...
      \path (L0) edge[->] node[trans, above] {} (G2);
      \path (K0) edge[->] node[trans, above] {} (D2);
      \path (R0) edge[->] node[trans, above] {} (G3);
    \end{tikzpicture}
  %
\end{center}
%%% Local Variables:
