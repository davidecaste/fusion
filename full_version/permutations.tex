...
\begin{remark}
	The relation $\equiv^p$ is an equivalence: \Cref{prop:abs} guarantees that it is well-defined, \Cref{rem:abscons} guarantees reflexivity, while symmetry and transitivity follow from, respectively \Cref{rem:inversa} and \Cref{rem:comp}.
\end{remark}
...
\end{definition}
\begin{remark}By \Cref{rem:empty2}
\end{remark}

We are now going to proceed towards the central result of this section: the uniqueness of a consistency permutation between two decorated derivations in a consuming rewriting system.
